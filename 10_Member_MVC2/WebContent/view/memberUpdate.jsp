...
<div align="center">
		...
		<form method="post" action="<%=request.getContextPath() %>/update_ok.do">
			...
			<table border="1" cellspacing="0" width="290">
				<tr>
					<th>회원 아이디</th>
					<td> <input name="mem_id" value="${content.getMemId() }" readonly> </td>
				</tr>
				<tr>
					<th>회원 이름</th>
					<td> <input name="mem_name" value="${content.getMemName() }" readonly> </td>
				</tr>
				<tr>
					<th>회원 비밀번호</th>
				...
				<tr>
					<th>회원 나이</th>
					<td> <input name="mem_age" value="${content.getAge() }"> </td>
				</tr>
				<tr>
					<th>회원 마일리지</th>
					<td> <input name="mem_mileage" value="${content.getMileage() }"> </td>
				</tr>
				<tr>
					<th>회원 직업</th>
					<td> <input name="mem_job" value="${content.getJob() }"> </td>
				</tr>
				<tr>
					<th>회원 주소</th>
					<td> <input name="mem_addr" value="${content.getAddr() }"> </td>
				</tr>	
				<tr>
