...
public class FrontController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
			...
			- 읽어 들일 때 사용하는 메서드는 load() 메서드를 이용하여 파일을 읽어들이게 됨.
		*/
		
		FileInputStream fis = new FileInputStream("C:\\NCS\\java\\workspace(jsp)\\14_Board_FileUpload\\src\\com\\upload\\controller\\mapping.properties");
		...
		if(value.substring(0, 7).equals("execute")) {
			 ...
			 * - Class 객체를 이용하려면 new 연산자의 사용 없이 동적으로 객체 생성이 가능함.
